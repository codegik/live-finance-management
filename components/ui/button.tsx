...
const buttonVariants = cva(
  // `border border-transparent` in the base is deliberate: the base layer in
  // globals.css still styles every bare `button` with a visible border, and
  // without an explicit border utility here that border would leak through on
  // the solid variants. Each variant that wants a real border overrides colour.
